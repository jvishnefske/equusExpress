...
})({"kNJ8h":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "257e569400c60dc1";
"use strict";
...
},{}],"hitQY":[function(require,module,exports,__globalThis) {
 ...
 */ parcelHelpers.export(exports, "setupObjectModel", ()=>setupObjectModel);
var _rxjs = require("rxjs");
function setupObjectModel(natsService, parentElement) {
  ...
  `;
    // --- Get DOM Elements ---
    const connectionStatusSpan = container.querySelector('#nats-om-connection-status');
    const channelListContainer = container.querySelector('#channel-list-container');
    const noChannelsMessage = container.querySelector('#no-channels-message');
    const subscriptions = new (0, _rxjs.Subscription)(); // To manage all RxJS subscriptions
    // --- Subscribe to NATS Connection Status ---
    subscriptions.add(natsService.connectionStatus.subscribe((status)=>{
    ...
    if (preDefinedChannels.length === 0) noChannelsMessage.style.display = 'block';
    else {
      ...
      `;
            ...
            const checkbox = channelItemDiv.querySelector(`#monitor-${channelName}`);
            const dataDisplayPre = channelItemDiv.querySelector(`#data-${channelName}`);
            const channelDataDiv = channelItemDiv.querySelector('.channel-data');
            ...
            } else console.error(`Object Model: Missing elements for channel ${channelName}.`);
        });
    }
...
},{"rxjs":"89Anq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["kNJ8h"], null, "parcelRequire8661", {})

//# sourceMappingURL=object-model.00c60dc1.js.map
