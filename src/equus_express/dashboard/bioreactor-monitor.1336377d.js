...
})({"ekbkQ":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "fb585e3c1336377d";
"use strict";
...
},{}],"4ZbP1":[function(require,module,exports,__globalThis) {
 ...
 */ parcelHelpers.export(exports, "setupBioreactorMonitor", ()=>setupBioreactorMonitor);
var _rxjs = require("rxjs"); // Keep RxJS as NatsSignalsService uses it
function setupBioreactorMonitor(natsService, parentElement) {
  ...
  `;
    ...
    const natsStatusEl = container.querySelector('#nats-connection-status');
    const batchIdEl = container.querySelector('#batch-id');
    const stateValueEl = container.querySelector('#state-value');
    const temperatureValueEl = container.querySelector('#temperature-value');
    const phValueEl = container.querySelector('#ph-value');
    const doValueEl = container.querySelector('#do-value');
    const holdButton = container.querySelector('#hold-button');
    const restartButton = container.querySelector('#restart-button');
    const bioreactorContent = container.querySelector('#bioreactor-content');
    const disconnectedMessage = container.querySelector('#disconnected-message');
  ...
  `;
    ...
    let currentStatus = null; // Hold current status
    ...
    const bioreactorStatusSub = natsService.getObservableForChannel('bioreactor.sk100.status').subscribe({
        next: (statusData)=>{
            ...
            if (currentStatus) {
                ...
                temperatureValueEl.textContent = currentStatus.temperature ? `${currentStatus.temperature.toFixed(2)} \xb0C` : 'N/A';
...
},{"rxjs":"89Anq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["ekbkQ"], null, "parcelRequire8661", {})

//# sourceMappingURL=bioreactor-monitor.1336377d.js.map
