var e=globalThis.parcelRequire8661;(0,e.register)("8Tk2M",function(t,a){Object.defineProperty(t.exports,"setupBioreactorMonitor",{get:()=>s,set:void 0,enumerable:!0,configurable:!0});var n=e("bgI6x");function s(e,t){t.innerHTML=`
    <div class="monitor-container">
      ...
      <div id="bioreactor-content">
        ...
        <div class="data-grid">
          ...
          <div class="data-item">
            <span class="label">Dissolved O\u{2082}</span>
  ...
  `;let a=t.querySelector("#nats-connection-status"),s=t.querySelector("#batch-id"),o=t.querySelector("#state-value"),r=t.querySelector("#temperature-value"),i=t.querySelector("#ph-value"),c=t.querySelector("#do-value"),l=t.querySelector("#hold-button"),d=t.querySelector("#restart-button"),u=t.querySelector("#bioreactor-content"),p=t.querySelector("#disconnected-message"),b=document.createElement("style");b.textContent=`
